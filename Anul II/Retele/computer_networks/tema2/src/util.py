...
def construieste_mesaj_raw(ip_src, ip_dst, port_s, port_d, mesaj, protocol = socket.IPPROTO_UDP):
    ...
    '''
    checksum_bytes = struct.pack('!B', 0)
    udp_header = port_s_bytes + port_d_bytes + length_bytes + checksum_bytes
    ...
    mesaj_binar =  ip_pseudo_header + udp_header + checksum_bytes + mesaj_bytes
